...
class MeanEmbeddingTransformer(TransformerMixin):
    ...
    def _load_words(self):
        ...
        with open(self.args.embed_path, 'r', encoding="utf8") as file: ## Put path to 100 dimensional embedding here 
...
def load_sentences(data):
        ...
        for i in range(len(data)):
            sent,label,justification=data['statement'][i],data['multi_label'][i],data['justification'][i]
...
def main(args):
    ...
    met=MeanEmbeddingTransformer(args)
